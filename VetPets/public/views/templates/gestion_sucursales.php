...
<main class="flex-grow mt-8">
    <div class="flex flex-col md:flex-row justify-between items-center gap-4 px-4 py-3">
        ...
        <div class="flex h-10 w-full md:w-auto items-center justify-center rounded-lg bg-gray-200 dark:bg-gray-700 p-1">
            <label
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 p-4">
        <div
            ...
            <div class="flex flex-col grow p-4 gap-3">
                <p class="text-xl font-bold leading-tight tracking-[-0.015em] text-text-dark dark:text-text-light">
                    Sucursal Centro</p>
